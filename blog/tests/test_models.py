...
class BlogModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        blog = Blog.objects.create(name='Test Blog 1', author=blog_author,
...
class BlogCommentModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        test_user2.save()
        blog_author = BlogAuthor.objects.create(user=test_user1, bio='This is a bio')
        blog_test = Blog.objects.create(name='Test Blog 1', author=blog_author,
                                        description='Test Blog 1 Description')
        blog_comment = BlogComment.objects.create(description='Test Blog 1 Comment 1 Description',
                                                  author=test_user2, blog=blog_test)
